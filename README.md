...
These instructions will get you a copy of Qube up and running on your local machine and deployed onto an AWS server. Note that you *must download and install Qube locally and configure server/office options* before deploying to a server.

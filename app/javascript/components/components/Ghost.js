...
const Ghost = ({ width, height, fillColor }) => {

  return (
    <svg version="1.1" x="0px" y="0px" width={`${width}px`} height={`${height}px`} viewBox="0 0 512 512">
      <g>
        <g>
          <path fill={fillColor} d="M255.633,0C145.341,0.198,55.994,89.667,55.994,200.006v278.66c0,14.849,17.953,22.285,28.453,11.786l38.216-39.328
